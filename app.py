...
@login_required #权限拦截  未登录就不能访问该接口
def edit(movie_id):
...
def  index():
    ...
    return render_template('index.html', movies=movies) # 传入变量  默认从templates里面找
...
def test_url_for():
    ...
    print(url_for('user', name='greyli'))  # 输出：/user/greyli
    print(url_for('system', id='peter'))  # 输出：/user/peter
